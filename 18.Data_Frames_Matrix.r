...
st3_df <- function()
{
  ...
  s_df=data.frame(roll_number=c("200981A0107","200981A0108"),name=c("Ravi","Alekya"),gender=c("
M","F")
                  ,blood_group=factor(c("A+","B-")),grade=c(8,9))
...
#   5 200981A0105   Rani      F           O   8.5
#   6 200981A0107   Ravi    \nM          A+   8.0
#   7 200981A0108 Alekya      F          B-   9.0
#   8 200981A0107   Ravi    \nM          A+   8.0
#   9 200981A0108 Alekya      F          B-   9.0
#   
#   Extracting 3rd row and 5th row with column names name and grade
#   name grade
#   3 Rama   7.5
